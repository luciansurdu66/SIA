...
namespace SIA.Infrastructure.Migrations
{
    ...
    [Migration("20250112115758_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SIA.Domain.Entities.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SIA.Domain.Entities.Internship", b =>
                {
                    ...
                    b.Property<DateTime>("ApplicationEndline")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("SIA.Domain.Entities.Student", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SIA.Domain.Entities.Application", b =>
                {
                    ...
                    b.HasOne("SIA.Domain.Entities.Student", "Student")
                        .WithMany("Applications")
            ...
            modelBuilder.Entity("SIA.Domain.Entities.Company", b =>
                {
                    b.HasOne("SIA.Domain.Entities.User", "User")
                        .WithOne("Company")
                        .HasForeignKey("SIA.Domain.Entities.Company", "UserId");
            ...
            modelBuilder.Entity("SIA.Domain.Entities.Internship", b =>
                {
                    b.HasOne("SIA.Domain.Entities.Company", "Company")
            ...
            modelBuilder.Entity("SIA.Domain.Entities.Student", b =>
                {
                    b.HasOne("SIA.Domain.Entities.User", "User")
                        .WithOne("Student")
                        .HasForeignKey("SIA.Domain.Entities.Student", "UserId");
